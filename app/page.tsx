...
export default function Home() {
  return (
    <>
      <div className="relative z-10 min-h-screen pt-24 pb-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full lg:w-auto lg:flex-1">
        ...
        <div className="relative w-full lg:w-auto lg:flex-1 h-80 md:h-96 lg:h-[500px] flex items-center justify-center">
          <div className="relative w-full h-full max-w-80 md:max-w-96 lg:max-w-[500px] max-h-80 md:max-h-96 lg:max-h-[500px] animate-float">
            ...
            <div className="relative z-10 w-full h-full rounded-2xl overflow-hidden border border-primary/30 shadow-[0_0_50px_rgba(37,157,244,0.2)] bg-black/40 backdrop-blur-sm group">
              ...
              <div className="absolute top-4 right-4 md:top-10 md:right-10 glass-panel p-3 rounded-lg animate-bounce duration-3000">
                <span className="  text-primary text-3xl">
                  <MdOutlineToken />
                </span>
              </div>

              <div className="absolute bottom-10 left-4 md:bottom-20 md:left-10 glass-panel px-4 py-2 rounded-lg flex items-center gap-2">
