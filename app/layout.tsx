...
export const metadata: Metadata = {
  title: "Vishal Pandit",
  description: "Mern Stack Developer | Tech Enthusiast | Open Source Contributor",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${spaceGrotesk.className} font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-white overflow-x-hidden transition-colors duration-300`}
      >
